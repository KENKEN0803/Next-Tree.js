  ...
  _initScene(rootPath, gltfContent) {
    ...
    loader.parse(
      ...
      (data) => {
        ...
        const defaultThreeReflection = document
          .getElementById('defaultThreeReflection')
          .textContent.split('{face}');
        let envMap;
        ...
        if (defaultThreeReflection.length === 2) {
          ...
          envMap = new THREE.CubeTextureLoader().load([
            envPath + 'posx' + envFormat,
            envPath + 'negx' + envFormat,
            envPath + 'posy' + envFormat,
            envPath + 'negy' + envFormat,
            envPath + 'posz' + envFormat,
            envPath + 'negz' + envFormat,
          ]);
          ...
          new RGBELoader().setDataType(THREE.HalfFloatType).load(envPath, (texture) => {
